...
<head>
    ...
    <!-- Modules -->
    @yield('css')
    @vite(['resources/sass/admin/main.scss', 'resources/js/admin/dashmix/app.js'])
...
<div id="page-container"
    ...
    @include('admin.layouts.snippets.right-bar')

    @include('admin.layouts.snippets.sidebar')

    @include('admin.layouts.snippets.header')
    ...
    @include('admin.layouts.snippets.footer')
